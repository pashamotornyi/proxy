...
# SSH: приоритет 22, затем 2222; стандартные алгоритмы OpenSSH
SSH_PORTS = [22, 2222]
CONNECT_TIMEOUT = 25
LOGIN_TIMEOUT = 45
KEEPALIVE_INTERVAL = 10

BUILD_TAG = "bot-ssh-default-algos-2025-09-29-15-21"
...
# ===== Подключение по SSH: 22 -> 2222, стандартные алгоритмы =====
...
@bot.event
async def on_ready():
    print(f"Starting ProxySetup DEFAULT SSH, {BUILD_TAG}")
